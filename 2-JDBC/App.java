...
public class App{
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/world","root","1012");
        ...
        String query2="insert into details values(234,'SANYAM'),"+"(243,'ARPITA'),"+"(376,'ABC')";
